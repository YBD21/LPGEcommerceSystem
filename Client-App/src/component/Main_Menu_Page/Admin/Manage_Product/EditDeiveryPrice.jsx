...
const EditDeiveryPrice = () => {
     const [prices, setPrices] = useState({ current: 0, old: 0, refillCurrent: 100, refillOld: 75 });
  return (
   <div className="flex flex-col mx-2 overflow-hidden">
      ...
      <table className="w-3/4 max-lg:w-full text-left table-collapse mx-auto">
        <thead >
          <tr className=''>
          <th className="px-4 py-2 border-2 border-black text-center text-gray-800 
          bg-gray-200">Delivery Type</th>
            <th className="px-4 py-2 border-2 border-black text-center text-gray-800 bg-orange-300">Old Delivery  Price</th>
            <th className="px-4 py-2 border-2 border-black text-center text-gray-800 bg-green-300">Current Delivery  Price</th>
            <th className="px-4 py-2 border-2 border-black text-center text-gray-800 bg-yellow-200">Purposed Delivery Price</th>
          </tr>
        </thead>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            Rs. {prices.current}</td>
            <td className="px-4 py-2 border-2 border-black text-center bg-yellow-200">Rs.{0}</td>
          </tr>
